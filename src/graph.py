...
path_icon={i:Icon(i) for i in df['exe_path'].unique()}
...
ax1=sns.stripplot(data=df,y='exe_path',x='instance_time',palette=colors,linewidth=1.2,size=6.9)
...
ax2.xaxis.set_major_locator(MultipleLocator(60 if df['runtime'].max()>60 else 30))
